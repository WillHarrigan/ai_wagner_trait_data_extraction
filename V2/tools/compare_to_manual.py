...
RESOLVERS: dict = {
    ...
    "breeding_type":               _cat_scalar("life_form", "breeding_type"),
    ...
    # Colors (raw strings)
    "ray_color":          _raw("inflorescence_specific_morphology", "ray_color"),
    "floret_color":       _raw("inflorescence_specific_morphology", "floret_color"),
    "spathe_color":       _raw("inflorescence_specific_morphology", "spathe_color"),
    ...
    "head_length":                       _meas("inflorescence_specific_morphology", "head_length"),
    "head_diameter":                     _meas("inflorescence_specific_morphology", "head_diameter"),
    ...
    "florets_length":                    _meas("inflorescence_specific_morphology", "florets_length"),
    ...
    "spadix_length":                     _meas("inflorescence_specific_morphology", "spadix_length"),
    ...
    "pappus_length":                     _meas("inflorescence_specific_morphology", "pappus_length"),
    ...
    "ray_length":                        _dim_axis("inflorescence_specific_morphology", "ray_dimensions", "length"),
    "ray_width":                         _dim_axis("inflorescence_specific_morphology", "ray_dimensions", "width"),
    ...
    "spathe_length":                     _dim_axis("inflorescence_specific_morphology", "spathe_dimensions", "length"),
    "spathe_width":                      _dim_axis("inflorescence_specific_morphology", "spathe_dimensions", "width"),
